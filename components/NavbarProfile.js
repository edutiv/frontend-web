  ...
  return (
    <div className="flex justify-between w-full h-[76px] pl-20 pr-20 shadow sticky z-50">
      ...
      <div className="grid content-center ">
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button className="inline-flex justify-center items-center gap-2 w-full bg-white font-medium px-2 py-[0.5rem] rounded text-gray-700 hover:bg-gray-50">
              <p>
                Hi, Annette
              </p>
              <Image
          ...
          <Transition
            ...
            leaveTo="transform opacity-0 scale-95"
          >
            <Menu.Items className="absolute right-0 py-2 mt-2 origin-top-right bg-white rounded-md shadow-lg w-80 ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div className="mx-4 ">
                <Menu.Item>
                  {({ active }) => (
                    <MyLink href="/test">
